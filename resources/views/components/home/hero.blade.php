            ...
            <div class="w-full lg:w-6/12 px-4">
                <div class="hero-content">
                    <h1
                        ...
                        My Name is Mohamed Shehata. <br />
                        I am <span class="rounded-md text-amber-600">Software Developer</span>.
                    </h1>
                    <p class="text-base mb-8 max-w-[520px]">
                        I am a developer with 1+ year of experience. <br />
                        I love to challenge my self and find new goals and learn new technologies to make value for my
                        live.
                        <br>
                    </p>
